...
const Img = styled.div`
  ...
  height: 40px;
  margin-right: 15px;
  background: url("/images/slices/pfind.png") no-repeat;
  background-size: 100% 100%;

  &:hover {
    background-image: url("/images/slices/pfind-hover.png");
  }
`;
...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    ...
    // <img src="/images/slices/pfind.png" style={{ marginRight: "15px" }} width="40" alt="" />
