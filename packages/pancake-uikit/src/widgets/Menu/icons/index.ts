...
export { default as PartyChainIcon } from "./PartyChain";
export { default as PfindIcon } from "./Pfind";
export { default as PhomeIcon } from "./Phome";
export { default as PstarIcon } from "./Pstar";
export { default as PbagIcon } from "./Pbag";
export { default as PdoctorIcon } from "./Pdoctor";
export { default as PinfoIcon } from "./Pinfo";
export { default as PmailIcon } from "./Pmail";
